...
// ==========================================
// FIX POSISI BALOK PAS MASUK KOTAK GRID HP
// ==========================================
...
function getCanvasTouchPos(e) {
    ...
    // 1. Hitung posisi sentuhan relatif terhadap elemen canvas
    const relativeX = touch.clientX - rect.left;
    const relativeY = touch.clientY - rect.top;
    
    // 2. Hitung perbandingan skala ukuran canvas di layar vs ukuran asli canvas (width/height atribut)
    const scaleX = canvas.width / rect.width;
    const scaleY = canvas.height / rect.height;
    
    // 3. Konversi koordinat agar pas presisi dengan logika game di laptop
    return {
        clientX: relativeX * scaleX,
        clientY: relativeY * scaleY
    };
}
