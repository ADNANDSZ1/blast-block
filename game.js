...
// ==========================================
// SENSOR SENTUHAN LAYAR HP (TOUCH EVENTS)
// ==========================================

canvas.addEventListener('touchstart', (e) => {
    e.preventDefault();
    const touch = e.touches[0];
    // Mengirim koordinat sentuhan jari agar dibaca seperti klik mouse
    startDrag({ 
...
canvas.addEventListener('touchmove', (e) => {
    e.preventDefault();
    const touch = e.touches[0];
    // Jika game Anda menggunakan fungsi mousemove terpisah, panggil di sini.
    // Untuk saat ini, kita samakan dengan pergerakan koordinat sentuhan jari.
